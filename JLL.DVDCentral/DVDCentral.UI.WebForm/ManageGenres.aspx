<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageGenres.aspx.cs" Inherits="DVDCentral.UI.WebForm.ManageGenres" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-row ml-2 mt-2">
        <div class="control-label col-md-2"> 
           <asp:Label ID="lblGenresPick" runat="server" Text="Genres:"></asp:Label></div>
        <div class="control-label col-md-3">
            <asp:DropDownList ID="ddlGenres"
                runat="server"
                AutoPostBack="true" OnSelectedIndexChanged="ddlGenres_SelectedIndexChanged">
            </asp:DropDownList> 
        </div>
    </div>
