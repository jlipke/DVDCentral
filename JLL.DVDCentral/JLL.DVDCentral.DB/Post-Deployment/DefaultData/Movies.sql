BEGIN
	...
	the Spider-Man suit to help Fury and fellow superhero Mysterio stop the evil entities from wreaking havoc across the continent', 'imgpath', 9.99, 15, 3, 1, 1),
	...
	and Bo discuss the old days, they soon start to realize that theyre worlds apart when it comes to what they want from life as a toy.', 'imgpath', 10.99, 23, 1, 1, 2),
	...
	without success. Their efforts attract Beetlejuice, a rambunctious spirit whose "help" quickly becomes dangerous for the Maitlands and innocent Lydia.', 'imgpath', 3.99, 2, 2, 2, 3)
